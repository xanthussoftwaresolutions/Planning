...
if (!$.ig.Grid) {
	...
	$.extend($.ig.Grid, {
		...
		locale: {
			...
			widthChangeFromPixelsToPercentagesNotSupported: "No se puede cambiar de forma dinámica la opción del ancho de la cuadrícula de píxeles a porcentajes.",
			widthChangeFromPercentagesToPixelsNotSupported: "No se puede cambiar de forma dinámica la opción del ancho de la cuadrícula de porcentajes a píxeles.",
