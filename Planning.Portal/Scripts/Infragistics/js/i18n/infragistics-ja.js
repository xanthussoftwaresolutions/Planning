...
(function ($) {
    ...
    if (!$.ig.Grid) {
	    ...
	    $.extend($.ig.GridHiding, {
		    locale: {
			    ...
			    columnChooserShowText: "非表示",
			    columnChooserHideText: "表示",
    ...
    $.extend($.ig.igGridMultiColumnHeaders, {
    	locale: {
    	    ...
    	    atLeastOneColumnShouldBeShownWhenCollapseOrExpand: '複数列ヘッダーを展開/縮小するときに 1 列以上表示されている必要があります。',
    	    collapsedColumnIconTooltip: "展開",
    	    expandedColumnIconTooltip: "縮小"
    	}
    });
