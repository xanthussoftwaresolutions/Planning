...
if (!$.ig.Grid) {
    ...
    $.extend($.ig.Grid, {
        ...
        locale: {
            ...
            widthChangeFromPixelsToPercentagesNotSupported: "Опцията width на мрежата на може да бъде сменяна динамично от пиксели в проценти.",
            widthChangeFromPercentagesToPixelsNotSupported: "Опцията width на мрежата на може да бъде сменяна динамично от проценти в пиксели.",
