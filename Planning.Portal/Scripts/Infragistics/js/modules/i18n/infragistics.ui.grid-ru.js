...
if (!$.ig.Grid) {
	...
	$.extend($.ig.Grid, {
		...
		locale: {
			...
			widthChangeFromPixelsToPercentagesNotSupported: "Динамическая замена значения ширины сетки в пикселах на значение в процентах невозможна.",
			widthChangeFromPercentagesToPixelsNotSupported: "Динамическая замена значения ширины сетки в процентах на значение в пикселах невозможна.",
