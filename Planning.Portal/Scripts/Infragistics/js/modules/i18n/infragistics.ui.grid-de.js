    ...
    if (!$.ig.Grid) {
	    ...
	    $.extend($.ig.Grid, {
		    ...
		    locale: {
			    ...
			    widthChangeFromPixelsToPercentagesNotSupported: "Die Option Rasterbreite kann nicht dynamisch von Pixeln auf Prozente umgestellt werden.",
			    widthChangeFromPercentagesToPixelsNotSupported: "Die Option Rasterbreite kann nicht dynamisch von Prozenten auf Pixel umgestellt werden.",
