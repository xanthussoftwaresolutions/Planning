...
(function ($) {
    ...
    MagicSearch.prototype = {
        ...
        deleteData: function (id) {
            ...
            setTimeout(() => {
                ...
                if (options.showMultiSkin) {
                    ...
                    //$input.css('padding-bottom', lineNum * styles.sightHeight + styles.paddingTop);
        ...
        searchData: function (isAll, isScroll) {
            ...
            if (data.length === 0) {
                let noResult = options.noResult ? options.noResult : 'no result found';
