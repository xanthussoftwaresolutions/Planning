...
if (!$.ig.Grid) {
	...
	$.extend($.ig.Grid, {
		...
		locale: {
			...
			widthChangeFromPixelsToPercentagesNotSupported: "Impossible de faire passer dynamiquement l'option de largeur de grille des pixels aux pourcentages.",
			widthChangeFromPercentagesToPixelsNotSupported: "Impossible de faire passer dynamiquement l'option de largeur de grille des pourcentages aux pixels.",
